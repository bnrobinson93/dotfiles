...
name: unslop
description: >-
  Unslop every assistant response and all human-facing text. Invoke on every turn after
  task-specific voice rules. Preserve the requested register, including terse caveman; remove
  AI tells without expanding or polishing that voice.
---
...
3. Add soul within the active register (see next section).
4. Self-audit: "What makes this obviously AI generated?" Fix remaining tells.

## Adding soul

Removing patterns is half the job. Sterile, voiceless writing is just as obvious.
Caveman soul comes from exact word choice, rhythm, and specificity. Keep its length.
