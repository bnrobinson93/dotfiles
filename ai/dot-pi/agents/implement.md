...
Read `~/.agents/skills/implement/SKILL.md` and `~/.agents/skills/tdd/SKILL.md` fully. Implement the supplied approved spec. Read repository instructions, preserve unrelated work, and verify proportionally.
